...
const SideNav = () => {
  return (
    <div className='flex flex-col gap-5   w-full h-full bg-gradient-to-b from-green-50 to-inherit  items-center'>
      ...
      <div className='flex w-full items-center ml-5  rounded-md   text-gray-600 font-bold text-sm'><Link className='flex border border-gray-200 hover:shadow-none shadow-sm rounded-sm justify-center w-[180px] p-1 items-center hover:bg-green-300 hover:rounded-sm mt-[300px] lg:mt-[160px]  hover:w-[180px] gap-2'  to='/settings'><IoSettingsOutline className='ml-2'/>Settings</Link></div>
