...
const TopNav = () => {
    ...
    return (
        <div className="w-full overflow-x-hidden">
            {/* Top Navigation */}
            <div className="flex fixed top-0 z-50 w-full h-[50px] bg-white items-center justify-between px-5 max-w-screen">
                {/* SideNav Toggle Button */}
                <button onClick={toggleButtons} className="cursor-pointer">
                ...
                {/* Search Bar */}
                <form className="flex items-center justify-between md:rounded-full md:border border-gray-200 w-[500px] px-3 max-w-full">
                    <input
                        type="text"
                        name="search"
                        value={input.search}
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Link to="/login">
                        <button className="lg:p-2 p-1 flex hover:bg-green-700 items-center justify-center md:w-[85px] w-[50px] rounded-sm md:rounded-md text-white text-sm bg-green-600">
